...
import ModalTambahPosition from "@/Components/Modal/Position/ModalTambahPosition";
import ModalEditPosition from "@/Components/Modal/Position/ModalEditPosition";
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="bg-white rounded-xl p-5">
                    <div className="flex justify-between items-center mb-4">
                        <p className="text-lg font-medium">Daftar Posisi</p>
                        {permissions.includes("position-add") && (
                            <button
