...
const Sidebar = ({ isOpen, onToggle }) => {
    ...
    const sidebarMenu = Object.entries({
        ...
        OPERASIONAL: [
            permissions.includes("pekerjaan-index") && {
                id: 201,
                icon: <PiBuildingApartmentLight size={21} className="mr-4" />,
                text: "Pekerjaan",
                url: "/operasional/pekerjaan",
            },
        ],
        MASTER: [
            permissions.includes("department-index") && {
                id: 1,
                icon: <PiCirclesFourLight size={21} className="mr-4" />,
                text: "Departement",
                url: "/master/department",
            },
            permissions.includes("position-index") && {
                id: 2,
                icon: <PiCirclesFourLight size={21} className="mr-4" />,
                text: "Posisi",
                url: "/master/position",
